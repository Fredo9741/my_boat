    ...
    <div class="container mx-auto px-4">
        <div class="flex justify-between items-center py-4 md:py-5">
            ...
            <a href="{{ route('home') }}" class="flex items-center group">
                <img src="{{ asset('images/logo-myboat.svg') }}" alt="My Boat - Courtier Maritime Océan Indien" class="h-12 md:h-14 w-auto transition-transform group-hover:scale-105 drop-shadow-lg" loading="eager" decoding="async">
            </a>
