...
@section('title', 'Ajouter un type - Administration')
        ...
        <main class="lg:col-span-3">
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-800">Ajouter un type de bateau</h1>
                        <p class="text-gray-600 mt-2">Créez un nouveau type de bateau</p>
                    </div>
