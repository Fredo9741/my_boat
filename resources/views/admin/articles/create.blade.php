        ...
        <main class="lg:col-span-3">
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-2">Créez un nouvel article pour votre blog</p>
                    </div>
            ...
            <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text"
                                   ...
                                   required>
                            <p class="text-sm text-gray-500 mt-1">Le slug sera généré automatiquement à partir du titre.</p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition cursor-pointer" id="featured-image-dropzone">
                                ...
                                <div id="featured-image-placeholder">
                                    ...
                                    <p class="text-gray-600">Cliquez ou glissez une image ici</p>
                ...
                <div class="flex items-center justify-end space-x-4">
                    ...
                    <button type="submit" name="status" value="draft" class="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg font-semibold transition">
                        <i class="fas fa-save mr-2"></i>Enregistrer comme brouillon
                    </button>
                    <button type="submit" name="status" value="published" class="px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg font-semibold transition">
